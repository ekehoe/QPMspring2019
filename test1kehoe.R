...
objects()
rm(list =ls()) 
# removes things from your environment
...
logic <- TRUE
logic
# can be shorted to T or F, still means TRUE or FALSE

## 1.6: Saving R script56, 60, 50, 26, 45, 35, 41, 43, 34, 42, 37, 39, 33, 28, 52, 48, 27, 20, 44, 32vector
